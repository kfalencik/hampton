    ...
    <div id="about-us" class="max-w-8xl p-5 py-15 mx-auto">
        <div class="max-w-4xl">
            <div class="divider-block">
                ...
                <div>
                    <p class="text-black">Founded by three friends who combined their unique experiences to create a company capable of handling the most demanding projects. </p>
